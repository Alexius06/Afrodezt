...
export default function About() {
    ...
    return (
        <main className="bg-paper">
            ...
            <section ref={aboutRef} className={`w-full flex flex-col ${aboutInView ? "animate-fadeInLeft" : "opacity-0"} md:flex-row justify-center items-center md:items-stretch my-8 px-4 gap-6`}>
                {/* writeup Container */}
                <div className="relative w-full md:w-[70%] rounded-lg min-h-[400px] px-4 md:px-8 py-4 mb-12 md:mb-20">
                    {/* Heading & Accent Rule */}
                    <div className="mb-8">
                    ...
                    <Link
                        to="/contact"
                        className="inline-flex items-center justify-center font-display rounded bg-gradient-to-r from-fire to-ember px-8 py-3.5 text-sm md:text-base font-bold uppercase tracking-wider text-white shadow-md hover:shadow-xl hover:shadow-fire/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300"
                    >
                        Get in Touch
                    </Link>
                </div>
                ...
                {/* Stat Count Wrapper */}
                <div className="w-full ml-0 md:w-[30%] flex items-center">
                    <StatCountSection isVisible={aboutInView} ref={aboutRef} />
                </div>
            </section>
            <section ref={founderRef} className="w-full bg-maroon flex flex-col relative overflow-hidden">
                <div className="w-full flex ">
                    <div className= {`w-[45%] h-full flex flex-col mx-5 my-5 overflow-hidden rounded-lg hover:rotate-[-1deg] duration-700 transition-all ${founderInView ? "animate-reveal" : "opacity: 0"}`}>
                        <img src="/assets/hq-2.jpg" className=" hover:scale-110 duration-700 transition-all " alt="" srcset="" />
                    </div>
                    <div className="flex flex-col flex-wrap text-paper text-2xl text-center w-[55%] h-full my-40">
                        <p className={`${founderInView ? "animate-fadeInRight" : "opacity: 0"}`}>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut iure fuga optio quis adipisci ut reprehenderit voluptatem non! Ipsum quisquam a id assumenda. Unde dolor ipsum reiciendis nesciunt a inventore?
                        </p>
                        <div className={`absolute left-[50%] bottom-8 flex ${founderInView ? "animate-reveal" : "opacity: 0"}`}>
                            <span className="inline-start text-center">-</span>
                            <p className="text-center italic text-paper font-body opacity-70 ">CEO/GMD of Afrodezt Group </p>
            ...
            <section>
                <PartnerCredentialsSection partnersRef={partnersRef} partnersInView={partnersInView} />
            </section>
